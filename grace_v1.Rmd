...
# max(n_fataility) coming up as 0...??
```

## Model + Tests

Merge covid & hr/demo data
...
### Regression Test: 2021  
SES factors vs. # covid cases  
* predictors = median income, number of minorities (black + hispanic), segregation score, and ses rank  
* outcome = # covid cases
...
SES factors alone significantly correlated with number of COVID cases in each county.

### QQ: want compare OR n_vax for minority vs. white... QQ
