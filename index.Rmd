...
Regardless, the models showed that the predictors smoking, obesity, physical inactivity, and unemployment are all associated with having received the first dose of a COVID vaccine. Using this information, public health professional can target resources and interventions to people who fit these predictors.
