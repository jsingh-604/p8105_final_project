...
Question 1: Which health factors are associated with COVID-19 incidences?
...
<img src="images/model1.png" style="width:75%">



Health factors are com

Health factors are conditions within each county that can be improved 

Health factors represent community conditions that we can change to improve health and opportunity, such as access to
quality education, living wage jobs, quality clinical care, nutritious foods, green spaces, and secure and affordable housing.
We measure four health factor areas.



First, we were interested in testing whether health factor scores in each county are associated with COVID-19 incidences.
