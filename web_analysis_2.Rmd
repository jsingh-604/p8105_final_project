...
m5 = comb %>% 
  filter(year == '2021') %>% 
  lm(n_deaths ~ segregation + p_minority + median_income + medage 
     + pop_d, data = .)
...
Adjusting for median age and population density, only median income and % minority (Black and Hispanic) are significantly associated with the number of COVID deaths (p < .05).