...
Before testing association between county health factors (HR) and COVID, we wanted to see rather there are any observable patterns between COVID cases & HR, COVID vaccination & HR, and COVID deaths & HR. County health factors ranking was categorized into 4 quartiles based on ranks with quartile 1 = highest ranks quartile and quartile 4 = lowest ranks.[(source)](https://www.countyhealthrankings.org/reports/state-reports/2022-new-york-state-report)
