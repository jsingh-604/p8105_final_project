...
Same steps were taken for each year except 2019; for this year, the sub-variables from the "Ranked Measure Data" sheet were labeled differently. As the original excel files contain multiple sheets. We only imported the sheets that contain variables of interest.  
...
6. **Dataset for Additional Analysis **  
